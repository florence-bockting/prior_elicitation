...
pd.read_pickle("elicit/results/parametric_prior/poisson_1/expert/elicited_statistics.pkl")["quantiles_group1"]
tf.reduce_mean(pd.read_pickle("elicit/results/parametric_prior/poisson_1/elicited_statistics.pkl")["quantiles_group1"],0)
