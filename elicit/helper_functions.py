...
def remove_unneeded_files(global_dict, save_results):
    path = global_dict["trainer"]["output_path"]
...
#     optimizer_dict = {}
#     if (
#         type(global_dict["optimizer"][
#             "optimizer_specs"
#             ]["learning_rate"]) is float
#     ):
#         optimizer_dict["init_lr"] = global_dict["optimizer"]["optimizer_specs"
#         ]["learning_rate"]
#     elif (
...
#     ):
#         optimizer_dict["lr_scheduler"] = global_dict["optimizer"][
#             "optimizer_specs"
#         ]["learning_rate"]._keras_api_names[0]
#         optimizer_dict["init_lr"] = global_dict["optimizer"][
#             "optimizer_specs"
#         ]["learning_rate"].initial_learning_rate
#         optimizer_dict["decay_steps"] = global_dict["optimizer"][
#             "optimizer_specs"
#         ]["learning_rate"].first_decay_steps
#     elif (
#         global_dict["optimizer"]["optimizer_specs"][
#             "learning_rate"
#         ]._keras_api_names[0]
...
#             "optimizer_specs"
#         ]["learning_rate"].initial_learning_rate
#         optimizer_dict["decay_rate"] = global_dict["optimizer"][
#             "optimizer_specs"
